...
const int LEDpins[] = {10, 11, 12, 13, A0, A1, A2};    // define the Arduino LED pins in use
...
//  const int led =13;
  const int anodePin = 9;
  const int cathodePin = 8;

//const int pten = A7;
//const int pelen = A6;

//int sensorPIN = pten;  // define the Arduino sensor pin 10
//  const int sensorPIN = pelen;  // define the Arduino sensor pin 11
...
//  digitalWrite(2, HIGH);
//  pinMode(pten, INPUT);
//  digitalWrite(pten, HIGH);
//  digitalWrite(pelen, LOW);
...
//      break;
  ...
  {
//    digitalWrite(lePin, LOW);   // set the LED off
     Serial.print("---------------");
  }
...
/////////////------------------------------------------------------------------------
//-------create time string from hr-min-sec----------------
String klok() {
